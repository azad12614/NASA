      ...
      <div class="goal">
        ...
        <ul>
          ...
          <li>
            ...
            <strong>Recycle:</strong> Reduce waste by recycling paper, glass,
          ...
          <li>
            ...
            <strong>Buy eco-friendly products:</strong> Look for products made
            sustainably and with minimal environmental impact.
          </li>
          <li>
          ...
          <li>
            ...
            <strong>Cut back on meat:</strong> Consider becoming vegetarian for
            one day a week to reduce your environmental footprint.
          </li>
          <li>
          ...
          <li>
            ...
            <strong>Pet Adopt:</strong> Support local animal shelters and avoid
            contributing to pet overpopulation.
          </li>
          <li>
            <span class="material-symbols-outlined">co2</span>
            <strong>Offset your carbon emissions:</strong> Calculate your carbon
            footprint and purchase climate credits.
          </li>
          <li>
            <span class="material-symbols-outlined">info</span>
            <strong>Stay informed:</strong> Follow climate news and engage with
            the Global Goals online or through social media.
          </li>
        </ul>
      </div>
      <Footer></Footer>
